...
exports.configurePlayerLoans = configurePlayerLoans;
...
function configurePlayerLoans(loans) {
  loans = Array.isArray(loans) ? loans : _defaults2.default.player.loans;
  loans.forEach(function (loan) {
    if (!(0, _lodash4.default)(loan.principal) || loan.principal < 0) {
      loan.principal = 0;
    }
    if (!(0, _lodash4.default)(loan.interest) || loan.interest < 0) {
      loan.interest = 0;
    }
...
function configurePlayer(state) {
  ...
  p.cash = configurePlayerValueObject(p.cash, _defaults2.default.player.cash);
  p.bank = configurePlayerValueObject(p.bank, _defaults2.default.player.bank);
